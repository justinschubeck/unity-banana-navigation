...
6. Place the file in the course GitHub repository, in the `p1_navigation/` folder, and unzip (or decompress) the file. 

### Instructions

Follow the instructions in `p1_navigation/Navigation.ipynb` to get started with training your own agent!  
